...
--
-- Host: localhost:3306
-- Generation Time: Aug 25, 2025 at 11:58 AM
...
(1, 1016, 1016, 612, 'course', 0, 'Sample-Course', NULL, 90, 'America/New_York', '/store/1016/1.jpg', '/store/1016/1_c.jpg', '/store/1016/Become A Product Manager.mp4', 'upload', NULL, NULL, NULL, 0.00, NULL, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, 'active', 1656669428, 1656669564, NULL);
...
--
ALTER TABLE `permissions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19690;
